var options = {
    icon: {
        background: 'rgba(50, 190, 185, 0.6)',
        border: '#FF4444'
    },
    active: false,
    widget: document.getElementById('canvasWidget'),
    click: function (e) {
...
widgetService().addDockItem2(options).innerHTML = 'Canvas';
function canvasController() {
    ...
    canvas.height = widget.clientHeight * 0.9;
    draft.width = widget.clientWidth * 0.98;
    draft.height = widget.clientHeight * 0.9;
